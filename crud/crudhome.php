...
<head>
    ...
    <link rel="stylesheet" href="css/crudhome.css">
    <title>CRUD</title>
</head>
<body>
    <div class="container">
        ...
        <div class="card-head">
            ...
            <a type="button" class="newuser" href="newuser.php">New User</a>
            <!-- <img src="images/add_btn.png" alt="" width=20 height=20 > -->
                                    ...
                                    <td>
                                        <div class="action">
                                            ...
                                            <form action="code.php" method="POST">
                                                <button type="submit" name="delete_stagiaire" value="<?= $row->id; ?>" class="delete adelete">Delete</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
